...
<br>
	...
	<table border=1 width=550 height=30 bordercolor=black>
		...
		<tr>
			...
			<td align=center bgcolor=0063ce><font size=3 color=#FFFFFF><b>내 게 시 판</b></td>
...
<%   
	...
	try{ 
		...
		sql = sql + " from re_board where b_name='"+pname+"'order by ref desc, step ";
 ...
 %>
		...
		<tr height=22 bgcolor=ffffff onMouseOver=this.style.backgroundColor='#FFF8DE'  onMouseOut=this.style.backgroundColor='#FFFFFF'>
			...
			<td width=230 align="left"><a href='member_show.jsp ?b_id=<%= b_id %>'>
...
<%		// 페이지 구현부
			...
			if ((startPage-limit)>0){ %>
				...
				<a href='Mywrite.jsp?pageNUM=<%=startPage-1%>'>[이전]<a>
...
%>
					...
					<a href='Mywrite.jsp?pageNUM=<%=i%>'><%=i%><a>
...
<%
			...
			if ((startPage+limit)<=pagecount){ %>
  				...
  				<a href='Mywrite.jsp?pageNUM=<%=startPage+limit%>'>[다음] <a>
...
%>
			...
			<a href="member_write_form.jsp"><img src="img/m_bt10.gif" border=0 align=absmiddle></a>

			<a href="member_board_list.jsp"><img src="img/m_bt06.gif" border=0 align=absmiddle></a>
