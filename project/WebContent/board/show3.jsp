...
<tr>
	...
	<tr>
	   <td  bgcolor=#7eaee9 ></td>
	   <td colspan=3 bgcolor=ffffff>
	    <table  > <tr align="center" >
         <img border=0 name=picmedium height=307 width=525  src="../product/image/<%=photo%>">
         </tr>
  </table>
	...
	<tr>
	   ...
	   <td colspan=3 bgcolor=ffffff>
	    <table>
	      <tr>           
	         <textarea cols=70 rows=20  name="content" style="height:482;"><%=b_content%></textarea>    
      </tr>
  </table>
