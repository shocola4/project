...
<tr> 
    <td width=200 height=40 valign=top bgcolor=#ffffff >
     ...
     <table width=200 border=0 cellspacing=1 cellpadding=0>
      ...
      <tr> 
          <td><a href="../product/categoryall.jsp?c=1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../img/nav_２_back.jpg',1);MM_showHideLayers('computer','','hide','pc','','show','software','','hide','network','','hide','digital','','hide','etc','','hide')"><img name="Image2" border=0 src="../img/nav_2.jpg" width=210 height=40 style="padding-bottom:8px"></a></td>
      </tr>
      <tr> 
          <td><a href="../product/categoryall.jsp?c=40" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../img/nav_３_back.jpg',1);MM_showHideLayers('computer','','hide','pc','','hide','software','','show','network','','hide','digital','','hide','etc','','hide')"><img name="Image3" border=0 src="../img/nav_3.jpg" width=210 height=40 style="padding-bottom:8px"></a></td>
      </tr>
      <tr> 
          <td><a href="../product/categoryall.jsp?c=26" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../img/nav_４_back.jpg',1);MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','show','digital','','hide','etc','','hide')"><img name="Image4" border=0 src="../img/nav_4.jpg" width=210 height=40 style="padding-bottom:8px"></a></td>
       </tr>
       <tr> 
           <td><a href="../product/categoryall.jsp?c=34" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../img/nav_５_back.jpg',1);MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','hide','digital','','show','etc','','hide')"><img name="Image5" border=0 src="../img/nav_５.jpg" width=210 height=40 style="padding-bottom:8px"></a></td>
       </tr>
       <tr> 
           <td><a href="../product/categoryall.jsp?c=19" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../img/nav_６_back.jpg',1);MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','hide','digital','','hide','etc','','show')"><img name="Image6" border=0 src="../img/nav_6.jpg" width=210 height=40 style="padding-bottom:8px"></a></td>
      </tr>
     </table>
...
<div id="software" style="position:absolute; left:215px; top:420px; width:100px; z-index:200; visibility: hidden"> 
  <table width=110 border=1 cellspacing=2 cellpadding=0 bgcolor="#de93a1" onMouseOver="MM_showHideLayers('computer','','hide','pc','','hide','software','','show','network','','hide','digital','','hide','etc','','hide')" onMouseOut="MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','hide','digital','','hide','etc','','hide')">
   <tr>
        <td onmouseover="this.style.background='#00ff99'" style="padding-top: 2px"  onmouseout="this.style.background='#f9edef'" width=99 bgcolor=#f9edef><a  href="../product/category.jsp?c=40" target=_top>&nbsp;&nbsp;운영체제</a></td></tr>
	<tr>
